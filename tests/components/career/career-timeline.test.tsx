...
describe("CareerTimeline", () => {
  it("renders all career positions", () => {
    render(<CareerTimelineContent careerData={careerData} activeLabel="Activo" />);
  ...
  it("renders primary positions with distinct styling", () => {
    const { container } = render(<CareerTimelineContent careerData={careerData} activeLabel="Activo" />);
