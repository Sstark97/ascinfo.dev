    ...
    <div className="group flex h-full min-h-[280px] flex-col rounded-xl border border-white/5 bg-[#222222] p-6 transition-all duration-300 hover:border-white/10">
      <div className="flex flex-col gap-5 sm:flex-row sm:items-start">
        ...
        <div className="relative h-24 w-24 shrink-0 overflow-hidden rounded-xl">
          <Image src="/professional-headshot-software-developer-man.jpg" alt="Aitor Santana" fill className="object-cover" priority />
          {/* Amber glow effect */}
      ...
      <div className="mt-6 flex-1">
        <p className="text-base leading-relaxed text-muted-foreground">
          Obsessed with{" "}
          <span className="rounded bg-[#FCA311]/10 px-1.5 py-0.5 font-medium text-[#FCA311]">Clean Code</span>,{" "}
          <span className="rounded bg-[#FCA311]/10 px-1.5 py-0.5 font-medium text-[#FCA311]">TDD</span>, and{" "}
